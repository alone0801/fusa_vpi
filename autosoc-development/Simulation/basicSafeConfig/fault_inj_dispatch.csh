...
#################################################
    ...
    #$JOB_DISPATCH xrun -r FI_TIME_600 -fault_max_msgs 1 -fault_sim_run -fault_timeout 800ms -run -exit -input $FAULTS_CONFIG/$i-fault_inj_config.f -licq -nostdout -l logs/xrun_fs_${TYPE}_fault_${FAULTID}.log -f $FILES_DIR/xrunPlusArgs.f
